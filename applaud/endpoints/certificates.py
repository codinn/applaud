...
class CertificateListEndpoint(Endpoint):
    path = '/v1/certificates'

    def fields(self, *, certificate: Union[CertificateField, list[CertificateField]]=None) -> CertificateListEndpoint:
        ...
        :returns: self
        :rtype: applaud.endpoints.CertificateListEndpoint
        '''
        if certificate: self._set_fields('certificates',certificate if type(certificate) is list else [certificate])
        return self
        
    def filter(self, *, certificate_type: Union[CertificateType, list[CertificateType]]=None, display_name: Union[str, list[str]]=None, serial_number: Union[str, list[str]]=None, id: Union[str, list[str]]=None) -> CertificateListEndpoint:
    ...
    def sort(self, *, certificate_type: SortOrder=None, display_name: SortOrder=None, id: SortOrder=None, serial_number: SortOrder=None) -> CertificateListEndpoint:
    ...
    def limit(self, number: int=None) -> CertificateListEndpoint:
    ...
    def create(self, request: CertificateCreateRequest) -> CertificateResponse:
        ...
        return CertificateResponse.parse_obj(response_json)
