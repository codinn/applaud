...
class BetaAppReviewSubmissionListEndpoint(Endpoint):
    path = '/v1/betaAppReviewSubmissions'

    def fields(self, *, beta_app_review_submission: Union[BetaAppReviewSubmissionField, list[BetaAppReviewSubmissionField]]=None, build: Union[BuildField, list[BuildField]]=None) -> BetaAppReviewSubmissionListEndpoint:
        ...
        :returns: self
        :rtype: applaud.endpoints.BetaAppReviewSubmissionListEndpoint
        '''
    ...
    def filter(self, *, beta_review_state: Union[BetaReviewState, list[BetaReviewState]]=None, build: Union[str, list[str]]) -> BetaAppReviewSubmissionListEndpoint:
    ...
    def include(self, relationship: Union[Include, list[Include]]) -> BetaAppReviewSubmissionListEndpoint:
    ...
    def limit(self, number: int=None) -> BetaAppReviewSubmissionListEndpoint:
    ...
    def create(self, request: BetaAppReviewSubmissionCreateRequest) -> BetaAppReviewSubmissionResponse:
        ...
        return BetaAppReviewSubmissionResponse.parse_obj(response_json)
