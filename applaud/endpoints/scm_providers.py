...
class ScmProviderListEndpoint(Endpoint):
    path = '/v1/scmProviders'

    def fields(self, *, scm_provider: Union[ScmProviderField, list[ScmProviderField]]=None, scm_repository: Union[ScmRepositoryField, list[ScmRepositoryField]]=None) -> ScmProviderListEndpoint:
        ...
        :returns: self
        :rtype: applaud.endpoints.ScmProviderListEndpoint
        '''
    ...
    def limit(self, number: int=None) -> ScmProviderListEndpoint:
...
class RepositoryListOfScmProviderEndpoint(IDEndpoint):
    path = '/v1/scmProviders/{id}/repositories'

    def fields(self, *, scm_repository: Union[ScmRepositoryField, list[ScmRepositoryField]]=None) -> RepositoryListOfScmProviderEndpoint:
        '''Fields to return for included related types.
        ...
        :returns: self
        :rtype: applaud.endpoints.RepositoryListOfScmProviderEndpoint
        '''
        if scm_repository: self._set_fields('scmRepositories',scm_repository if type(scm_repository) is list else [scm_repository])
        return self
        
    def filter(self, *, id: Union[str, list[str]]=None) -> RepositoryListOfScmProviderEndpoint:
    ...
    def limit(self, number: int=None) -> RepositoryListOfScmProviderEndpoint:
        '''Number of resources to return.
